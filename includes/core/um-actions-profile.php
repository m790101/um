				...
				<?php if ( $args['show_name'] ) { ?>
					<div class="um-name">
						...
						<a href="<?php echo esc_url( um_user_profile_url() ); ?>"
						   title="<?php echo esc_attr( um_user( 'display_name' ) ); ?>"><?php echo um_user( 'display_name', 'html' ); ?>11111</a>
						   <?php echo do_shortcode('[show_my_userid text="id: 0165086%s"]');?>
...
function um_add_edit_icon( $args ) {
	...
	if ( true === UM()->fields()->editing ) { ?>
		...
		<div class="um-profile-edit um-profile-headericon">
			<a href="javascript:void(0);" class="um-profile-edit-a um-profile-save"><i class="um-faicon-check"></i>Save</a>
		</div>
	...
	<div class="um-profile-edit um-profile-headericon">
		...
		<a href="javascript:void(0);" class="um-profile-edit-a"><i class="um-faicon-edit">Edit</i></a>
...
function um_add_profile_fields( $args ) {
	if ( true === UM()->fields()->editing ) {
		...
		//echo do_shortcode(' [alg_back_button label="Go Back" type="button" class="alg_back_button_floating"]');
		...
		echo do_shortcode(' [alg_back_button label="Go Back" type="button" class="alg_back_button_floating"]');
		echo ('<h3>See other member...</h3>');
		echo do_shortcode(' [ultimatemember form_id="189"]');
	}
